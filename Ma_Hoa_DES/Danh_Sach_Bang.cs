...
{
    public class Danh_Sach_Bang
    {
        public static readonly int[] PC1 ={ 57, 49, 41, 33, 25, 17, 9, 1, 58, 50,
                                          42, 34, 26, 18, 10, 2, 59, 51, 43, 35,
                                          27, 19, 11, 3, 60, 52, 44, 36, 63, 55,
                                          47, 39, 31, 23, 15, 7, 62, 54, 46, 38,
                                          30, 22, 14, 6, 61, 53, 45, 37, 29, 21,
                                          13, 5, 28, 20, 12, 4 };
        public static readonly int[] PC2 ={ 14, 17, 11, 24, 1, 5, 3, 28, 15, 6, 21,
        ...
        public static readonly int[] IP_1 ={ 40, 8, 48, 16, 56, 24, 64, 32, 39, 7,
                                            ...
                                            49, 17, 57, 25 };
        public static readonly int[] E ={ 32, 1, 2, 3, 4, 5, 4, 5, 6, 7, 8, 9, 8,
                                          9, 10, 11, 12, 13, 12, 13, 14, 15, 16,
                                          17, 16, 17, 18, 19, 20, 21, 20, 21, 22,
                                          23, 24, 25, 24, 25, 26, 27, 28, 29, 28,
                                          29, 30, 31, 32, 1 };
        public static readonly int[] P ={ 16, 7, 20, 21, 29, 12, 28, 17, 1, 15, 23,
